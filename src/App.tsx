  ...
  return (
    <nav className="w-full p-4 md:px-12 md:py-6 flex justify-between items-center z-50 relative">
      ...
      <div className="flex gap-3 md:gap-4">
        <div className="bg-type-black text-paper-white px-4 py-2 rounded-buttons text-[14px] md:text-[16px] leading-[1.71] cursor-pointer hover:bg-type-black/80 transition-colors">
          Log In
        </div>
        <div className="bg-bubblegum-red text-paper-white px-4 py-2 rounded-buttons text-[14px] md:text-[16px] leading-[1.71] cursor-pointer hover:bg-bubblegum-red/90 transition-colors">
          Start Writing
        </div>
      </div>
    </nav>
  ...
  return (
    <Section bg="bg-leafy-green" className="border-t-[6px] md:border-t-[8px] border-type-black">
      <div className="max-w-4xl mx-auto w-full text-center py-10 md:py-16">
        ...
        <button className="bg-type-black text-paper-white text-[20px] md:text-[36px] leading-[1.4] md:leading-[1.2] font-bold px-8 md:px-12 py-4 md:py-6 rounded-[24px] md:rounded-speechbubbles shadow-[6px_6px_0px_#fff] md:shadow-[8px_8px_0px_#fff] hover:-translate-y-1 hover:bg-grape-punch transition-all cursor-pointer inline-flex items-center">
